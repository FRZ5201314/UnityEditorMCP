...
namespace UnityMcp.UI
{
    ...
    {
        private const string MenuPath = "Tools/Unity MCP";
        ...
        {
            var window = GetWindow<McpBridgeWindow>(false, "Unity MCP", true);
        ...
        private static void OpenLogFile()
        {
            ...
            if (!File.Exists(path))
            {
                ...
                EditorUtility.DisplayDialog("Unity MCP", "日志文件还未生成: " + path, "确定");
                return;
            }
